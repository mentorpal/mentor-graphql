...
describe('uploadAnswer', () => {
  ...
  it(`throws an error if no questionId`, async () => {
    ...
    const response = await request(app)
      ...
      .send({
        query: `mutation {
          uploadAnswer(mentorId: "5ffdf41a1ee2c62111111111", answer: {})
        }`,
      });
    expect(response.status).to.equal(400);
  });
  ...
  it(`throws an error if no answer`, async () => {
    ...
    const response = await request(app)
      ...
      .send({
        query: `mutation {
          uploadAnswer(mentorId: "5ffdf41a1ee2c62111111111", questionId: "511111111111111111111112")
        }`,
      });
    expect(response.status).to.equal(400);
  });
  ...
  it('updates an answer', async () => {
    ...
    const response = await request(app)
      ...
      .send({
        query: `mutation {
          uploadAnswer(mentorId: "5ffdf41a1ee2c62111111111", questionId: "${questionId}", answer: ${answer})
        }`,
      });
    expect(response.status).to.equal(200);
    expect(response.body.data.uploadAnswer).to.eql(true);
  ...
  it(`throws an error if mentor does not exist`, async () => {
    ...
    const response = await request(app)
      ...
      .send({
        query: `mutation {
          uploadAnswer(mentorId: "5ffdf41a1ee2c62111199999", questionId: "511111111111111111111112", answer: {})
        }`,
      });
    expect(response.status).to.equal(200);
  ...
  it(`throws an error if question does not exist`, async () => {
    ...
    const response = await request(app)
      ...
      .send({
        query: `mutation {
          uploadAnswer(mentorId: "5ffdf41a1ee2c62111111111", questionId: "511111111111111111999999", answer: {})
        }`,
      });
    expect(response.status).to.equal(200);
    expect(response.body).to.have.deep.nested.property(
